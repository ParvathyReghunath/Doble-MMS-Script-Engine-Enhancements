...
/* --------  ---  ------   -------------------------------------------  */
/* 05/31/18  EJV  Added ACSELOG_DECF, ACSELOG_ENCF filtering macros.    */
...
#define ACSELOG_DECF0(log_enable,a) \
                SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),_acse_dec_logstr,a)
#define ACSELOG_DECF1(log_enable,a,b) \
                SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),_acse_dec_logstr,a,b)
#define ACSELOG_DECF2(log_enable,a,b,c) \
                SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),_acse_dec_logstr,a,b,c)
#define ACSELOG_DECF3(log_enable,a,b,c,d) \
                SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),_acse_dec_logstr,a,b,c,d)

#define ACSELOG_DECF0C(log_enable,a)        SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),a)
#define ACSELOG_DECF1C(log_enable,a,b)      SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),a,b)
#define ACSELOG_DECF2C(log_enable,a,b,c)    SLOGC_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),a,b,c)
#define ACSELOG_DECF3C(log_enable,a,b,c,d)  SLOGC_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),a,b,c,d)

#define ACSELOG_DECFH(log_enable,a,b)       SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_DEC),a,b)
...
#define ACSELOG_ENCF0(log_enable,a) \
                SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),_acse_enc_logstr,a)
#define ACSELOG_ENCF1(log_enable,a,b) \
                SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),_acse_enc_logstr,a,b)
#define ACSELOG_ENCF2(log_enable,a,b,c) \
                SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),_acse_enc_logstr,a,b,c)
#define ACSELOG_ENCF3(log_enable,a,b,c,d) \
                SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),_acse_enc_logstr,a,b,c,d)

#define ACSELOG_ENCF0C(log_enable,a)        SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),a)
#define ACSELOG_ENCF1C(log_enable,a,b)      SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),a,b)
#define ACSELOG_ENCF2C(log_enable,a,b,c)    SLOGC_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),a,b,c)
#define ACSELOG_ENCF3C(log_enable,a,b,c,d)  SLOGC_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),a,b,c,d)

#define ACSELOG_ENCFH(log_enable,a,b)       SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & ACSE_LOG_ENC),a,b)
