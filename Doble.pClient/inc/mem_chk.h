...
/* --------  ---  ------   -------------------------------------------  */
/* 03/25/14  JRB  Use always MSMEM_GEN as context in SMEM macros.       */
...
/************************************************************************/
  ...
  /* NOTE: these macros ignore the caller's "ctx" parameter and use always MSMEM_GEN.*/
  #define M_MALLOC(ctx,x)       x_m_malloc  (MSMEM_GEN,x,  thisFileName,__LINE__)
  #define M_CALLOC(ctx,x,y)     x_m_calloc  (MSMEM_GEN,x,y,thisFileName,__LINE__)
  #define M_REALLOC(ctx,x,y)    x_m_realloc (MSMEM_GEN,x,y,thisFileName,__LINE__)
  #define M_STRDUP(ctx,x)       x_m_strdup  (MSMEM_GEN,x,  thisFileName,__LINE__)
  #define M_FREE(ctx,x)         x_m_free    (MSMEM_GEN,x,  thisFileName,__LINE__)
  ...
  /* NOTE: these macros ignore the caller's "ctx" parameter and use always MSMEM_GEN.*/
  #define M_MALLOC(ctx,x)       nd_m_malloc  (MSMEM_GEN,x)
  #define M_CALLOC(ctx,x,y)     nd_m_calloc  (MSMEM_GEN,x,y)
  #define M_REALLOC(ctx,x,y)    nd_m_realloc (MSMEM_GEN,x,y)
  #define M_STRDUP(ctx,x)       nd_m_strdup  (MSMEM_GEN,x)
  #define M_FREE(ctx,x)         nd_m_free    (MSMEM_GEN,x)
