...
/* --------  ---  ------   -------------------------------------------  */
/* 01/11/17  DSF           IPv6 support                                 */
/* 11/09/16  DSF           Performance improvemens                      */
/* 06/10/16  DSF           Add sockaddr to CLNP_PARAM                   */
/* 08/22/12  JRB           Chg CLNP_LOG_* to UINT to match clnp_debug_sel*/
...
#define CLNP_LOG_ERR            0x00000001
#define CLNP_LOG_NERR           0x00000002

/* to log CLNP-user indication or request */
#define CLNP_LOG_REQ            0x00000010
#define CLNP_LOG_IND            0x00000020

/* to log CLNP encoding/decoding or LLC encoding/decoding */

#define CLNP_LOG_ENC_DEC        0x00000100
#define CLNP_LOG_LLC_ENC_DEC    0x00000200

/* to log data read/written to sub-network */
#define CLSNS_LOG_REQ           0x00001000
#define CLSNS_LOG_IND           0x00002000
...
typedef struct
  ...
  struct sockaddr_in   addr_in; /* IPv4 address associated with network interface         */
                                /* may be used to select interface      */
  struct sockaddr_storage  addr_in6;/* IPv6 address associated with network interface         */
                                /* may be used to select interface      */
  ST_UINT16      rx_buf_size;   /* may be used to set PCAP receive buffer size in Kbytes  */
  }CLNP_PARAM;
