...
/* --------  ---  ------   -------------------------------------------  */
/* 07/23/18  JRB  Add MMS_OVSTRING (similar to MMS_BVSTRING).           */
/* 05/21/14  JRB           ASN1_ENC_CTXT: add fixedOffs flag.           */
/* 06/29/12  JRB           Add "asn1r_maxlen_wr_*" functions.           */
...
/* This structure defines the format used to pass "variable length      */
/* octetstring" data between the user and                               */
/* the ASN.1 encoder/decoder (i.e. ms_asn1_to_local & ms_local_to_asn1).*/
/* NOTE: For octetstrings longer than 1 byte, the actual data extends   */
/*       beyond the end of this struct.                                 */

typedef struct
  {
  ST_INT16 len;     /* length in bytes  */
  ST_UCHAR data[1];
  } MMS_OVSTRING;
...
/* General variables and pointers                                       */
  ...
  ST_BOOLEAN fixedOffs;         /* do fixed length encoding     */
...
/************************************************************************/
/* "asn1r_maxlen_*" functions for computing maximum ASN.1 encoded length*/
/* (these functions DO NOT encode the data).                            */
/************************************************************************/
ST_VOID asn1r_maxlen_wr_u8     (ASN1_ENC_CTXT *ac, ST_UINT8 data);
ST_VOID asn1r_maxlen_wr_u16    (ASN1_ENC_CTXT *ac, ST_UINT16 data);
ST_VOID asn1r_maxlen_wr_u32    (ASN1_ENC_CTXT *ac, ST_UINT32 data);
ST_VOID asn1r_maxlen_wr_i8     (ASN1_ENC_CTXT *ac, ST_INT8 data);
ST_VOID asn1r_maxlen_wr_bool   (ASN1_ENC_CTXT *ac, ST_BOOLEAN data);
ST_VOID asn1r_maxlen_wr_i16    (ASN1_ENC_CTXT *ac, ST_INT16 data);
ST_VOID asn1r_maxlen_wr_i32    (ASN1_ENC_CTXT *ac, ST_INT32 data);
ST_VOID asn1r_maxlen_wr_vstr   (ASN1_ENC_CTXT *ac, const ST_CHAR *data, ST_INT max_len);
ST_VOID asn1r_maxlen_wr_btod   (ASN1_ENC_CTXT *ac, MMS_BTOD *data);
ST_VOID asn1r_maxlen_wr_time   (ASN1_ENC_CTXT *ac, time_t data);
ST_VOID asn1r_maxlen_wr_objid  (ASN1_ENC_CTXT *ac, ST_INT16 *data, ST_INT num_el);
ST_VOID asn1r_maxlen_wr_bitstr (ASN1_ENC_CTXT *ac, ST_UCHAR *bitptr, ST_INT numbits);
ST_VOID asn1r_maxlen_wr_octstr (ASN1_ENC_CTXT *ac, const ST_UCHAR *octptr, ST_INT numoctets);
ST_VOID asn1r_maxlen_wr_float  (ASN1_ENC_CTXT *ac, ST_FLOAT data);
ST_VOID asn1r_maxlen_wr_double (ASN1_ENC_CTXT *ac, ST_DOUBLE data);
ST_VOID asn1r_maxlen_wr_utc_time (ASN1_ENC_CTXT *ac, MMS_UTC_TIME *data);
ST_VOID asn1r_maxlen_wr_utf8   (ASN1_ENC_CTXT *ac, ST_CHAR *data, ST_INT el_len);

#ifdef INT64_SUPPORT
ST_VOID asn1r_maxlen_wr_i64 (ASN1_ENC_CTXT *ac, ST_INT64 data);
ST_VOID asn1r_maxlen_wr_u64 (ASN1_ENC_CTXT *ac, ST_UINT64 data);
#endif  /* INT64_SUPPORT        */
