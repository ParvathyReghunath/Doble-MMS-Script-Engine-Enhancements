...
/* --------  ---  ------   -------------------------------------------  */
/* 01/09/17  JRB  Add IPV6_AR_NAME_SUFFIX define.                       */
/*                dib_entry_create: chg return from ST_VOID to ST_RET.  */
/* 05/16/14  EJV  Don't define *_dib_table if defined(SISCO_STACK_CFG). */
...
/* Add this suffix when generating IPv6 AR Name from SCL. */
#define IPV6_AR_NAME_SUFFIX       "/IPV6"
