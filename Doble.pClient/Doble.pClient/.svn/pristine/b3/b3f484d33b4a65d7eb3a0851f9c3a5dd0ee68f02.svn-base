...
/* --------  ---  ------   -------------------------------------------  */
/* 01/19/16  JRB  CRITICAL: Don't use "sizeof" on structures.           */
/*                May include padding on some systems.                  */
...
#define CLNP_8473_HDR_SEG_LEN   6
