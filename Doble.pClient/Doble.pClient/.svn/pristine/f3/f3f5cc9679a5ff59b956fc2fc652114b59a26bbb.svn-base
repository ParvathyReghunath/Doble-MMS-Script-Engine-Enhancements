...
/* --------  ---  ------   -------------------------------------------  */
/* 05/09/18  EJV  TP0_CONN: added log_enable for filtered logging.      */
/* 11/10/14  JRB  Add preferred_max_tpdu_len_enc.                       */
...
typedef struct
  ...
  ST_UINT32 preferred_max_tpdu_len_enc; /* Preferred Max TPDU len (encoded)*/
