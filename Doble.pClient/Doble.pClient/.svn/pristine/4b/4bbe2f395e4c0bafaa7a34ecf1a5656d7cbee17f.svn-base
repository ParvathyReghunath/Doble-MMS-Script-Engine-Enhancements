...
/* --------  ---  ------   -------------------------------------------  */
/* 05/09/18  EJV  ACSE_CONN: added log_enable for filtered logging.     */
/* 01/09/17  JRB  ACSE_CONN: added useIpv6, ipv6Addr.                   */
...
typedef struct tagACSE_CONN
  {
  ST_BOOLEAN useIpv6;                   /* SD_TRUE if this conn uses IPV6*/
  /* common part */
  ...
  union
    ...
    ST_UCHAR ipv6Addr [16];             /* OR IPv6 Addr                 */
    }remNetAddr;
