...
/* --------  ---  ------   -------------------------------------------  */
/* 05/14/18  EJV  Added SOCK_LOG_DEBUG mask and macros (use for XSocket)*/
/*                Added SOCK_LOG_FLOWF, SOCK_LOG_RXF. SOCK_LOG_TXF      */
/*                filtering macros.                                     */
...
extern SD_CONST ST_CHAR *SD_CONST  SOCK_LOG_DEBUG_TEXT;
...
/* filtering macros */
#define SOCK_LOG_FLOWF0(log_enable,ctx,a) \
        SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),SOCK_LOG_FLOW_TEXT,a)
#define SOCK_LOG_FLOWF1(log_enable,ctx,a,b) \
        SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),SOCK_LOG_FLOW_TEXT,a,b)
#define SOCK_LOG_FLOWF2(log_enable,ctx,a,b,c) \
        SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),SOCK_LOG_FLOW_TEXT,a,b,c)
#define SOCK_LOG_FLOWF3(log_enable,ctx,a,b,c,d) \
        SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),SOCK_LOG_FLOW_TEXT,a,b,c,d)
#define SOCK_LOG_FLOWF4(log_enable,ctx,a,b,c,d,e) \
        SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),SOCK_LOG_FLOW_TEXT,a,b,c,d,e)
#define SOCK_LOG_FLOWF5(log_enable,ctx,a,b,c,d,e,f) \
        SLOG_5 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),SOCK_LOG_FLOW_TEXT,a,b,c,d,e,f)

/* Continuation log macros      */
#define SOCK_LOG_FLOWFC0(log_enable,ctx,a) \
        SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),a)
#define SOCK_LOG_FLOWFC1(log_enable,ctx,a,b) \
        SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),a,b)
#define SOCK_LOG_FLOWFC2(log_enable,ctx,a,b,c) \
        SLOGC_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),a,b,c)
#define SOCK_LOG_FLOWFC3(log_enable,ctx,a,b,c,d) \
        SLOGC_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),a,b,c,d)
#define SOCK_LOG_FLOWFC4(log_enable,ctx,a,b,c,d,e) \
        SLOGC_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),a,b,c,d,e)
#define SOCK_LOG_FLOWFC5(log_enable,ctx,a,b,c,d,e,f) \
        SLOGC_5 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_FLOW),a,b,c,d,e,f)
...
#define SOCK_LOG_RXF0(log_enable,ctx,a) \
        SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_RX),SOCK_LOG_RX_TEXT,a)
#define SOCK_LOG_RXF1(log_enable,ctx,a,b) \
        SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_RX),SOCK_LOG_RX_TEXT,a,b)
#define SOCK_LOG_RXF2(log_enable,ctx,a,b,c) \
        SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_RX),SOCK_LOG_RX_TEXT,a,b,c)
#define SOCK_LOG_RXF3(log_enable,ctx,a,b,c,d) \
        SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_RX),SOCK_LOG_RX_TEXT,a,b,c,d)
#define SOCK_LOG_RXF4(log_enable,ctx,a,b,c,d,e) \
        SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_RX),SOCK_LOG_RX_TEXT,a,b,c,d,e)
#define SOCK_LOG_RXF5(log_enable,ctx,a,b,c,d,e,f) \
        SLOG_5 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_RX),SOCK_LOG_RX_TEXT,a,b,c,d,e,f)

#define SOCK_LOG_RXFH(log_enable,ctx,a,b) \
        SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_RX),a,b)
...
#define SOCK_LOG_TXF0(log_enable,ctx,a) \
        SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_TX),SOCK_LOG_TX_TEXT,a)
#define SOCK_LOG_TXF1(log_enable,ctx,a,b) \
        SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_TX),SOCK_LOG_TX_TEXT,a,b)
#define SOCK_LOG_TXF2(log_enable,ctx,a,b,c) \
        SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_TX),SOCK_LOG_TX_TEXT,a,b,c)
#define SOCK_LOG_TXF3(log_enable,ctx,a,b,c,d) \
        SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_TX),SOCK_LOG_TX_TEXT,a,b,c,d)
#define SOCK_LOG_TXF4(log_enable,ctx,a,b,c,d,e) \
        SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_TX),SOCK_LOG_TX_TEXT,a,b,c,d,e)
#define SOCK_LOG_TXF5(log_enable,ctx,a,b,c,d,e,f) \
        SLOG_5 ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_TX),SOCK_LOG_TX_TEXT,a,b,c,d,e,f)

#define SOCK_LOG_TXFH(log_enable,ctx,a,b) \
        SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_TX),a,b)


/*********************** SOCK_LOG_DEBUG Macros *****************************/

#define SOCK_LOG_DEBUG0(ctx,a) \
        SLOG_0 ((!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_DEBUG),SOCK_LOG_DEBUG_TEXT,a)
#define SOCK_LOG_DEBUG1(ctx,a,b) \
        SLOG_1 ((!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_DEBUG),SOCK_LOG_DEBUG_TEXT,a,b)
#define SOCK_LOG_DEBUG2(ctx,a,b,c) \
        SLOG_2 ((!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_DEBUG),SOCK_LOG_DEBUG_TEXT,a,b,c)
#define SOCK_LOG_DEBUG3(ctx,a,b,c,d) \
        SLOG_3 ((!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_DEBUG),SOCK_LOG_DEBUG_TEXT,a,b,c,d)
#define SOCK_LOG_DEBUG4(ctx,a,b,c,d,e) \
        SLOG_4 ((!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_DEBUG),SOCK_LOG_DEBUG_TEXT,a,b,c,d,e)
#define SOCK_LOG_DEBUG5(ctx,a,b,c,d,e,f) \
        SLOG_5 ((!(ctx)->log_disable) && (sock_debug_sel & SOCK_LOG_DEBUG),SOCK_LOG_DEBUG_TEXT,a,b,c,d,e,f)
