...
/* --------  ---  ------   -------------------------------------------  */
/* 03/07/14  NAV           Remove spacs from mmsLogMaskMapCtrl          */
/* 03/25/13  JRB           Enable MMS_LOG_NERR by default.              */
...
#if !defined(NO_GLB_VAR_INIT)
ST_UINT mms_debug_sel = MMS_LOG_ERR | MMS_LOG_NERR;
...
LOGCFGX_VALUE_MAP mmsLogMaskMaps[] =
  {
    ...
    {"MMS_LOG_MIDD",    MMS_LOG_MIDD,     &mms_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, NULL, "DataDecode"},
    {"MMS_LOG_MIDE",    MMS_LOG_MIDE,     &mms_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, NULL, "DataEncode"},
