...
/* --------  ---  ------   -------------------------------------------  */
/* 06/15/18  EJV  Add TP_LOG_INDF,TP_LOG_REQF,TP_LOG_RIF filtering macros*/
...
/* filtering macros */
  ...
  #define TP_LOG_INDF0(log_enable,a)             SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),_tp4_flowup_logstr,a)
  #define TP_LOG_INDF1(log_enable,a,b)           SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),_tp4_flowup_logstr,a,b)
  #define TP_LOG_INDF2(log_enable,a,b,c)         SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),_tp4_flowup_logstr,a,b,c)
  #define TP_LOG_INDF3(log_enable,a,b,c,d)       SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),_tp4_flowup_logstr,a,b,c,d)
  #define TP_LOG_INDF4(log_enable,a,b,c,d,e)     SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),_tp4_flowup_logstr,a,b,c,d,e)
  #define TP_LOG_INDF5(log_enable,a,b,c,d,e,f)   SLOG_5 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),_tp4_flowup_logstr,a,b,c,d,e,f)
  #define TP_LOG_INDF6(log_enable,a,b,c,d,e,f,g) SLOG_6 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),_tp4_flowup_logstr,a,b,c,d,e,f,g)

  /* continuation log */

  #define TP_LOGC_INDF0(log_enable,a)           SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),a)
  #define TP_LOGC_INDF1(log_enable,a,b)         SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),a,b)
  #define TP_LOGC_INDF2(log_enable,a,b,c)       SLOGC_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),a,b,c)

  /* hex logging */

  #define TP_LOGH_INDF(log_enable,a,b)          SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),a,b)

  /* continuation hex logging */

  #define TP_LOGHC_INDF(log_enable,a,b)         SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWUP),a,b)
...
/* filtering macros */
  ...
  #define TP_LOG_REQF0(log_enable,a)             SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),_tp4_flowdown_logstr,a)
  #define TP_LOG_REQF1(log_enable,a,b)           SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),_tp4_flowdown_logstr,a,b)
  #define TP_LOG_REQF2(log_enable,a,b,c)         SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),_tp4_flowdown_logstr,a,b,c)
  #define TP_LOG_REQF3(log_enable,a,b,c,d)       SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),_tp4_flowdown_logstr,a,b,c,d)
  #define TP_LOG_REQF4(log_enable,a,b,c,d,e)     SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),_tp4_flowdown_logstr,a,b,c,d,e)
  #define TP_LOG_REQF5(log_enable,a,b,c,d,e,f)   SLOG_5 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),_tp4_flowdown_logstr,a,b,c,d,e,f)
  #define TP_LOG_REQF6(log_enable,a,b,c,d,e,f,g) SLOG_6 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),_tp4_flowdown_logstr,a,b,c,d,e,f,g)

  /* continuation log */

  #define TP_LOGC_REQF0(log_enable,a)           SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),a)
  #define TP_LOGC_REQF1(log_enable,a,b)         SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),a,b)
  #define TP_LOGC_REQF2(log_enable,a,b,c)       SLOGC_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),a,b,c)

  /* hex logging */

  #define TP_LOGH_REQF(log_enable,a,b)          SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),a,b)

  /* continuation hex logging */

  #define TP_LOGHC_REQF(log_enable,a,b)         SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (tp4_debug_sel & TP4_LOG_FLOWDOWN),a,b)
...
/* filtering macros */
  ...
  #define TP_LOG_RIF0(log_enable,m,a)             {if (m == TP_REQ) {TP_LOG_REQF0(log_enable,a);}             else {TP_LOG_INDF0(log_enable,a)};}
  #define TP_LOG_RIF1(log_enable,m,a,b)           {if (m == TP_REQ) {TP_LOG_REQF1(log_enable,a,b);}           else {TP_LOG_INDF1(log_enable,a,b);}}
  #define TP_LOG_RIF2(log_enable,m,a,b,c)         {if (m == TP_REQ) {TP_LOG_REQF2(log_enable,a,b,c);}         else {TP_LOG_INDF2(log_enable,a,b,c);}}
  #define TP_LOG_RIF3(log_enable,m,a,b,c,d)       {if (m == TP_REQ) {TP_LOG_REQF3(log_enable,a,b,c,d);}       else {TP_LOG_INDF3(log_enable,a,b,c,d);}}
  #define TP_LOG_RIF4(log_enable,m,a,b,c,d,e)     {if (m == TP_REQ) {TP_LOG_REQF4(log_enable,a,b,c,d,e);}     else {TP_LOG_INDF4(log_enable,a,b,c,d,e);}}
  #define TP_LOG_RIF5(log_enable,m,a,b,c,d,e,f)   {if (m == TP_REQ) {TP_LOG_REQF5(log_enable,a,b,c,d,e,f);}   else {TP_LOG_INDF5(log_enable,a,b,c,d,e,f);}}
  #define TP_LOG_RIF6(log_enable,m,a,b,c,d,e,f,g) {if (m == TP_REQ) {TP_LOG_REQF6(log_enable,a,b,c,d,e,f,g);} else {TP_LOG_INDF6(log_enable,a,b,c,d,e,f,g);}}

  #define TP_LOGC_RIF0(log_enable,m,a)     {if (m == TP_REQ) {TP_LOGC_REQF0(log_enable,a);}     else {TP_LOGC_INDF0(log_enable,a);}}
  #define TP_LOGC_RIF1(log_enable,m,a,b)   {if (m == TP_REQ) {TP_LOGC_REQF1(log_enable,a,b);}   else {TP_LOGC_INDF1(log_enable,a,b);}}
  #define TP_LOGC_RIF2(log_enable,m,a,b,c) {if (m == TP_REQ) {TP_LOGC_REQF2(log_enable,a,b,c);} else {TP_LOGC_INDF2(log_enable,a,b,c);}}

  #define TP_LOGH_RIF(log_enable,m,a,b)    {if (m == TP_REQ) {TP_LOGH_REQF(log_enable,a,b);}    else {TP_LOGH_INDF(log_enable,a,b);}}
  #define TP_LOGHC_RIF(log_enable,m,a,b)   {if (m == TP_REQ) {TP_LOGHC_REQF(log_enable,a,b);}   else {TP_LOGHC_INDF(log_enable,a,b);}}
