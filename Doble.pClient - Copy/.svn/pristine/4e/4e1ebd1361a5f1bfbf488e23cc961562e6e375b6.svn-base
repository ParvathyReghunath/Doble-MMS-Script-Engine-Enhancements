...
/* --------  ---  ------   -------------------------------------------  */
/* 05/31/18  EJV  Added COSP_LOG_ENCF, COSP_LOG_DECF filtering macros.  */
...
#define COSP_LOG_ENCF0(log_enable,a) \
        SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC),_cosp_enc_logstr,a)

#define COSP_LOG_ENCF1(log_enable,a,b) \
        SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC),_cosp_enc_logstr,a,b)

#define COSP_LOG_ENCF2(log_enable,a,b,c) \
        SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC),_cosp_enc_logstr,a,b,c)

#define COSP_LOG_ENCF3(log_enable,a,b,c,d) \
        SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC),_cosp_enc_logstr,a,b,c,d)

#define COSP_LOG_ENCF4(log_enable,a,b,c,d,e) \
        SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC),_cosp_enc_logstr,a,b,c,d,e)

  /* continuation macros */
#define COSP_LOG_ENCFC0(log_enable,a) \
        SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC),a)

#define COSP_LOG_ENCFC1(log_enable,a,b) \
        SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC),a,b)

  /* hex logging */
#define COSP_LOG_ENCFH(log_enable,a,b) \
        SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_ENC_HEX),a,b)
...
#define COSP_LOG_DECF0(log_enable,a) \
        SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC),_cosp_dec_logstr,a)

#define COSP_LOG_DECF1(log_enable,a,b) \
        SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC),_cosp_dec_logstr,a,b)

#define COSP_LOG_DECF2(log_enable,a,b,c) \
        SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC),_cosp_dec_logstr,a,b,c)

#define COSP_LOG_DECF3(log_enable,a,b,c,d) \
        SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC),_cosp_dec_logstr,a,b,c,d)

#define COSP_LOG_DECF4(log_enable,a,b,c,d,e) \
        SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC),_cosp_dec_logstr,a,b,c,d,e)

  /* continuation macros */
#define COSP_LOG_DECFC0(log_enable,a) \
        SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC),a)

  #define COSP_LOG_DECFC1(log_enable,a,b) \
        SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC),a,b)

  /* hex logging */
#define COSP_LOG_DECFH(log_enable,a,b) \
        SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (acse_debug_sel & COSP_LOG_DEC_HEX),a,b)
