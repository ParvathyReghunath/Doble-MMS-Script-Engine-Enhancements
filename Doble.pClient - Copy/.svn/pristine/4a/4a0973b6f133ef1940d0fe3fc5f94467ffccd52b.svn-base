...
/* --------  ---  ------   -------------------------------------------  */
/* 04/14/17  JRB           Updated version (6.2000) and copyright (2017).*/
/* 01/20/16  EJV           Updated copyright to 2016.                   */
/* 06/27/14  JRB           Chg 80X to 802. Updated version (6.0050).    */
/* 03/07/14  JRB           Updated version (6.0000.3).                  */
/* 02/07/14  JRB           Updated copyright and version (6.0000.2).    */
/* 09/16/13  JRB           Updated copyright and version (6.0000.1).    */
...
/************************************************************************/
#define MMSLITE_COPYRIGHT       "Copyright (c) 1986-2017 SISCO, Inc. All Rights Reserved."
#define MMSLITE_NAME            "MMS-LITE-802-001"
#define MMSLITE_VERSION         "6.2000"
