...
/* --------  ---  ------   -------------------------------------------  */
/* 05/13/14  EJV  BIND_CONTROL: rpl user_bind_id with user_bind_id_u64. */
/*                add_bind_sels, del_bind_sels, find_user_bind_id:      */
/*                  chg ST_VOID *user_bind_id to ST_UINT64 parameter.   */
...
typedef struct BIND_CONTROL_tag
  ...
  ST_UINT64  user_bind_id_u64;          /* user bind id, fixed size ST_UINT64 to use in IPC     */
...
ST_RET     add_bind_sels (BIND_CONTROL *bind_ctrl, ST_UINT max_binds,  ST_UCHAR *sels, ST_UINT sels_len,
                          ST_UINT64 user_bind_id_u64, BIND_CONTROL **p_bind_ctrl);  /* out: new entry*/
...
BIND_CONTROL *find_user_bind_id   (BIND_CONTROL *bind_ctrl, ST_UINT max_binds, ST_UINT64 user_bind_id_u64);
