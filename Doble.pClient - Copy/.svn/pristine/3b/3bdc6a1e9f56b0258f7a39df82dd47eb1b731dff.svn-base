...
/* --------  ---  ------   -------------------------------------------  */
/* 02/18/13  EJV  Added arAuthSignatureMethodTypeStrings and            */
/*                arAuthHashStrings for MACE time signing.              */
...
extern SECCFG_INT_TO_STRING     arAuthSignatureMethodTypeStrings[];
extern SECCFG_INT_TO_STRING     arAuthHashStrings[];
