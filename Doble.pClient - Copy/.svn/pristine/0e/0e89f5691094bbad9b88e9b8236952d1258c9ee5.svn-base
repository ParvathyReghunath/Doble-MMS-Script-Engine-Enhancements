...
/* --------  ---  ------   -------------------------------------------  */
/* 06/04/18  EJV  LOG_CTRL: double the size of filter_names arr for IPs.*/
/*                Added slog_add_filter proto.                          */
/* 04/27/18  MDE  Added filter support                                  */
/* 08/09/17  DSF  Improved SEV usage from SLOG macros                   */
/* 05/22/14  MDE  Brought SLOGALWAYSx macros up to date                 */
/* 05/16/14  MDE  Added _LOGCFG_DATATYPE_UINT32_HEX			*/
/* 05/30/13  MDE  Tweaks to unique trace file support			*/
/* 04/16/13  MDE  Currected macros to invoke SEV properly               */
/* 04/10/13  MDE  Removed all port defines; see SlogPorts.xlsx          */
/* 12/10/12  DSF  Added some more ESI ports                             */
/* 12/05/12  RWM  Added Reverse IC port reservations                    */
/* 11/16/12  RWM  Fixed SDE Slog Macro errors                           */
/* 10/11/12  MDE           Added logCfgReloadCallback                   */
/* 09/28/12  MDE           Added more for UAP components                */
/* 03/28/12  DSF           Reserved a port for UAP ESI                  */
...
/* Internal use only                                                    */
  ...
  FILE  *fp;
  FILE  *uFp;                    /* For use with unique file names       */
  } FILE_LOG_CTRL;
...
#define SLOG_MAX_FILTER_NAMES 20
...
/* Filtered Logging elements */
  ST_BOOLEAN filtered_logging_enable; /* Set SD_TRUE for filtered logging mode */
  ST_INT filter_name_count;
  ST_CHAR *filter_names[SLOG_MAX_FILTER_NAMES*2];  /* *2 for name and it's IP */
...
#define _LOGCFG_DATATYPE_UINT32_HEX    17
...
/* Callback, invoked when logCfgX loader was called */
extern ST_VOID (*logCfgReloadCallback) (ST_CHAR *logFileName, ST_BOOLEAN masksOnly, ST_RET rc);
...
ST_BOOLEAN slog_get_filter (LOG_CTRL *lc, ST_CHAR *filter, ST_BOOLEAN *presentOut);
ST_RET     slog_add_filter (LOG_CTRL *lc, ST_CHAR *filter);
...
#define SEV_TRACE_SLOG9(ena,str,fmt,a,b,c,d,e,f,g,h,i)      if(_sevCfg.trace.sevOptions.slogTraceMode)sevTraceSlog(ena,sLogCtrl,str,thisFileName,__LINE__,fmt,a,b,c,d,e,f,g,h,i)
#define SEV_TRACE_SLOG10(ena,str,fmt,a,b,c,d,e,f,g,h,i,j)   if(_sevCfg.trace.sevOptions.slogTraceMode)sevTraceSlog(ena,sLogCtrl,str,thisFileName,__LINE__,fmt,a,b,c,d,e,f,g,h,i,j)
#define SEV_TRACE_SLOG11(ena,str,fmt,a,b,c,d,e,f,g,h,i,j,k) if(_sevCfg.trace.sevOptions.slogTraceMode)sevTraceSlog(ena,sLogCtrl,str,thisFileName,__LINE__,fmt,a,b,c,d,e,f,g,h,i,j,k)
...
#define SEV_TRACE_SLOG9(ena,str,fmt,a,b,c,d,e,f,g,h,i)
#define SEV_TRACE_SLOG10(ena,str,fmt,a,b,c,d,e,f,g,h,i,j)
#define SEV_TRACE_SLOG11(ena,str,fmt,a,b,c,d,e,f,g,h,i,j,k)
...
#define SLOGALWAYS0(a) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a);                         SEV_TRACE_SLOG0(SD_TRUE,_slogAlwaysLogTypeStr,a);\
        } while(0)

#define SLOGALWAYS1(a,b) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b);                       SEV_TRACE_SLOG1(SD_TRUE,_slogAlwaysLogTypeStr,a,b);\
        } while(0)

#define SLOGALWAYS2(a,b,c) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c);                     SEV_TRACE_SLOG2(SD_TRUE,_slogAlwaysLogTypeStr,a,b,c);\
        } while(0)

#define SLOGALWAYS3(a,b,c,d) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d);                   SEV_TRACE_SLOG3(SD_TRUE,_slogAlwaysLogTypeStr,a,b,c,d);\
        } while(0)

#define SLOGALWAYS4(a,b,c,d,e) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e);                 SEV_TRACE_SLOG4(SD_TRUE,_slogAlwaysLogTypeStr,a,b,c,d,e);\
        } while(0)

#define SLOGALWAYS5(a,b,c,d,e,f) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e,f);               SEV_TRACE_SLOG5(SD_TRUE,_slogAlwaysLogTypeStr,a,b,c,d,e,f);\
        } while(0)

#define SLOGALWAYS6(a,b,c,d,e,f,g) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e,f,g);             SEV_TRACE_SLOG6(SD_TRUE,_slogAlwaysLogTypeStr,a,b,c,d,e,f,g);\
        } while(0)

#define SLOGALWAYS7(a,b,c,d,e,f,g,h) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e,f,g,h);           SEV_TRACE_SLOG7(SD_TRUE,_slogAlwaysLogTypeStr,a,b,c,d,e,f,g,h);\
        } while(0)

#define SLOGALWAYS8(a,b,c,d,e,f,g,h,i) \
        do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e,f,g,h,i);         SEV_TRACE_SLOG8(SD_TRUE,_slogAlwaysLogTypeStr,a,b,c,d,e,f,g,h,i);\
        } while(0)

#define SLOGALWAYS9(a,b,c,d,e,f,g,h,i,j) \
          do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e,f,g,h,i,j);\
        } while(0)

#define SLOGALWAYS10(a,b,c,d,e,f,g,h,i,j,k) \
          do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e,f,g,h,i,j,k);\
        } while(0)

#define SLOGALWAYS11(a,b,c,d,e,f,g,h,i,j,k,l) \
          do {_slog (sLogCtrl,_slogAlwaysLogTypeStr,thisFileName,__LINE__,a,b,c,d,e,f,g,h,i,j,k,l);\
        } while(0)

/* Continuation versions */
#define SLOGCALWAYS0(a) \
        do {_slogc (sLogCtrl,a);                         SEV_TRACE_SLOGC0(SD_TRUE,a);\
        } while(0)

#define SLOGCALWAYS1(a,b) \
        do {_slogc (sLogCtrl,a,b);                       SEV_TRACE_SLOGC1(SD_TRUE,a,b);\
        } while(0)

#define SLOGCALWAYS2(a,b,c) \
        do {_slogc (sLogCtrl,a,b,c);                     SEV_TRACE_SLOGC2(SD_TRUE,a,b,c);\
        } while(0)

#define SLOGCALWAYS3(a,b,c,d) \
        do {_slogc (sLogCtrl,a,b,c,d);                   SEV_TRACE_SLOGC3(SD_TRUE,a,b,c,d);\
        } while(0)

#define SLOGCALWAYS4(a,b,c,d,e) \
        do {_slogc (sLogCtrl,a,b,c,d,e);                 SEV_TRACE_SLOGC4(SD_TRUE,a,b,c,d,e);\
        } while(0)

#define SLOGCALWAYS5(a,b,c,d,e,f) \
        do {_slogc (sLogCtrl,a,b,c,d,e,f);               SEV_TRACE_SLOGC5(SD_TRUE,a,b,c,d,e,f);\
        } while(0)

#define SLOGCALWAYS6(a,b,c,d,e,f,g) \
        do {_slogc (sLogCtrl,a,b,c,d,e,f,g);             SEV_TRACE_SLOGC6(SD_TRUE,a,b,c,d,e,f,g);\
        } while(0)

#define SLOGCALWAYS7(a,b,c,d,e,f,g,h) \
        do {_slogc (sLogCtrl,a,b,c,d,e,f,g,h);           SEV_TRACE_SLOGC7(SD_TRUE,a,b,c,d,e,f,g,h);\
        } while(0)

#define SLOGCALWAYS8(a,b,c,d,e,f,g,h,i) \
        do {_slogc (sLogCtrl,a,b,c,d,e,f,g,h,i);         SEV_TRACE_SLOGC8(SD_TRUE,a,b,c,d,e,f,g,h,i);\
        } while(0)

#define SLOGCALWAYS9(a,b,c,d,e,f,g,h,i,j) \
          do {_slogc (sLogCtrl,a,b,c,d,e,f,g,h,i,j);\
        } while(0)

#define SLOGCALWAYS10(a,b,c,d,e,f,g,h,i,j,k) \
          do {_slogc (sLogCtrl,a,b,c,d,e,f,g,h,i,j,k);\
        } while(0)

#define SLOGCALWAYS11(a,b,c,d,e,f,g,h,i,j,k,l) \
          do {_slogc (sLogCtrl,a,b,c,d,e,f,g,h,i,j,k,l);\
        } while(0)
