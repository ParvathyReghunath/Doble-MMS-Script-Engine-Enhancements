...
/* --------  ---  ------   -------------------------------------------  */
/* 05/31/18  EJV  Added SSLE_LOG_FLOWF, SSLE_LOG_DEBUGF filtering macros*/
...
#define SSLE_LOG_FLOWF0(log_enable,a) \
          SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), "SSLE_LOG_FLOW", a)
#define SSLE_LOG_FLOWF1(log_enable,a,b) \
          SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), "SSLE_LOG_FLOW", a,b)
#define SSLE_LOG_FLOWF2(log_enable,a,b,c) \
          SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), "SSLE_LOG_FLOW", a,b,c)
#define SSLE_LOG_FLOWF3(log_enable,a,b,c,d) \
          SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), "SSLE_LOG_FLOW", a,b,c,d)
#define SSLE_LOG_FLOWF4(log_enable,a,b,c,d,e) \
          SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), "SSLE_LOG_FLOW", a,b,c,d,e)

#define SSLE_LOG_DEBUGF0(log_enable,a) \
          SLOG_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), "SSLE_LOG_DEBUG", a)
#define SSLE_LOG_DEBUGF1(log_enable,a,b) \
          SLOG_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), "SSLE_LOG_DEBUG", a,b)
#define SSLE_LOG_DEBUGF2(log_enable,a,b,c) \
          SLOG_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), "SSLE_LOG_DEBUG", a,b,c)
#define SSLE_LOG_DEBUGF3(log_enable,a,b,c,d) \
          SLOG_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), "SSLE_LOG_DEBUG", a,b,c,d)
#define SSLE_LOG_DEBUGF4(log_enable,a,b,c,d,e) \
          SLOG_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), "SSLE_LOG_DEBUG", a,b,c,d,e)

#define SSLE_LOG_DATAFH(log_enable,a,b) \
          SLOGH ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DATA)w,a,b)
...
#define SSLE_LOG_CFLOWF0(log_enable,a) \
          SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), a)
#define SSLE_LOG_CFLOWF1(log_enable,a,b) \
          SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), a,b)
#define SSLE_LOG_CFLOWF2(log_enable,a,b,c) \
          SLOGC_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), a,b,c)
#define SSLE_LOG_CFLOWF3(log_enable,a,b,c,d) \
          SLOGC_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), a,b,c,d)
#define SSLE_LOG_CFLOWF4(log_enable,a,b,c,d,e) \
          SLOGC_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_FLOW), a,b,c,d,e)

#define SSLE_LOG_CDEBUGF0(log_enable,a) \
          SLOGC_0 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), a)
#define SSLE_LOG_CDEBUGF1(log_enable,a,b) \
          SLOGC_1 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), a,b)
#define SSLE_LOG_CDEBUGF2(log_enable,a,b,c) \
          SLOGC_2 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), a,b,c)
#define SSLE_LOG_CDEBUGF3(log_enable,a,b,c,d) \
          SLOGC_3 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), a,b,c,d)
#define SSLE_LOG_CDEBUGF4(log_enable,a,b,c,d,e) \
          SLOGC_4 ((!sLogCtrl->filtered_logging_enable || log_enable) && (ssle_debug_sel & SSLE_LOG_DEBUG), a,b,c,d,e)
